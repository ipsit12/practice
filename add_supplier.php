...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <a href="SupplierDetails.php"><button class="btn btn-primary">Supplier Details</button></a>
                        ...
                        <form class="row g-3 needs-validation" action="./config.php" method="post" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" name="submit_suppliers_person" class="btn btn-grd-primary px-4">Submit</button>
