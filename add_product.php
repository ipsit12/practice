...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <a href="ProductDetails.php"><button class="btn btn-primary">Product Details</button></a>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3 needs-validation" action="./config.php" method="post" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="bsValidation3" placeholder="PRODUCT_NAME" name="product_name" required>
                                <div class="invalid-feedback">
                                    Please choose a PRODUCT_NAME.
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label for="bsValidation5" class="form-label">PRODUCT_IMAGE</label>
                                <input type="file" class="form-control" id="bsValidation5" placeholder="PRODUCT_IMAGE" name="image[]" multiple required>
                                <div class="invalid-feedback">
                                    Please provide a PRODUCT_IMAGE.
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label for="bsValidation4" class="form-label">PRODUCT_CATEGORY</label>
                                <input type="TEXT" class="form-control" id="bsValidation4" placeholder="PRODUCT_CATEGORY" name="product_category" required>
                                <div class="invalid-feedback">
                                    Please provide a valid PRODUCT_CATEGORY.
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label for="bsValidation4" class="form-label">PRODUCT_QUANTITY</label>
                                <input type="TEXT" class="form-control" id="bsValidation4" placeholder="PRODUCT_QUANTITY" name="product_quantity" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="bsValidation5" placeholder="PRODUCT_PRICE" name="product_price" required>
                                <div class="invalid-feedback">
                                    Please provide a PRODUCT_PRICE.
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <label for="bsValidation9" class="form-label">CHOOSE_SUPPLIER</label>
                                <select id="bsValidation9" name="supplier" class="form-select" required>
                                <?php
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="DATE" class="form-control" id="bsValidation5" placeholder="STORE_CREATED_AT" name="created_at" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" name="submit_product" class="btn btn-grd-primary px-4">Submit</button>
