...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2024 14:12:58 GMT -->
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Fire And Safety</title>
  <!--favicon-->
  ...
  <header class="top-header">
    <nav class="navbar navbar-expand align-items-center gap-4">
      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
        ...
        <a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="assets/images/county/08.png" width="20" alt=""><span class="ms-2">English</span></a>
