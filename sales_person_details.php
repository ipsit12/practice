...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <a href="add_sales_person.php"><button class="btn btn-primary mb-5">Back</button></a>

        <h6 class="mb-0 text-uppercase">Sales Person DETAILS</h6>
        <hr>
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php
                                    $select = "SELECT * FROM sales_person";
                            ...
                            <tr>
                                ...
                                <td>
                                                <?php foreach ($myarr as $filename): ?>
                                                    <img src="person_image/<?php echo $filename; ?>" alt="" width="100px">
                                                <?php endforeach; ?>
                                            </td>
                                <td><?php echo $row['phone_number'] ?></td>
                                <td><?php echo $row['address'] ?></td>
                                <td><?php echo $row['select_store'] ?></td>
                                <td><?php echo $row['join_at'] ?></td>
                                
                                <td><a href="delete_salesperson.php?id=<?php echo $row['id'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                <td><a href="edit_sales_person.php?id=<?php echo $row['id'];?>"><button class="btn btn-warning">Edit</button></a></td>
