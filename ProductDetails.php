...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <a href="add_product.php"><button class="btn btn-primary mb-5">Back</button></a>
                            ...
                            <tr>
                                ...
                                <td>
                                                <?php foreach ($myarr as $filename): ?>
                                                    <img src="product_image/<?php echo $filename; ?>" alt="" width="100px">
                                                <?php endforeach; ?>
                                            </td>
                                ...
                                <td><a href="delete_product.php?id=<?php echo $row['id'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                <td><a href="edit_product.php?id=<?php echo $row['id'];?>"><button class="btn btn-warning">Edit</button></a></td>
