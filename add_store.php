...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <!--end row-->
<a href="storedetails.php"><button class="btn btn-primary">StoreDetails</button></a>
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['store_employee'] ?></td>
                                <td><?php echo $row['created_at'] ?></td>
                                <td><a href="delete_store.php?id=<?php echo $row['id'];?>"><button class="btn btn-danger">Delete</button></a></td>
                                <td><a href="edit_store.php?id=<?php echo $row['id'];?>"><button class="btn btn-warning">Edit</button></a></td>
            ...
            <div class="col-xl-6 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3 needs-validation" action="./config.php" method="post" novalidate>
                            
                            <div class="col-md-12">
                                <label for="bsValidation3" class="form-label">STORE_NAME</label>
                                <input type="text" class="form-control" id="bsValidation3" placeholder="STORE_NAME" name="store_name" required>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="TEXT" class="form-control" id="bsValidation4" placeholder="STORE_ADDRESS" name="store_address" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="bsValidation5" placeholder="STORE_EMPLOYEE" name="store_employee" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" name="submit_store" class="btn btn-grd-primary px-4">Submit</button>
